$(document).ready(function(){
  ...
  $('#add').click(function(){
    ...
    // Other Detail here!
    // End (Delete button)
    append_text += ' <div class="col-lg-1"> <div class="text-center" style="margin-top: 8px;"> <button type="submit" id="'+i+'"class="btn btn-info btn-simple btn-xs btn_remove">Delete</button> </div></div></div></div>';
